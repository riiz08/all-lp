...
const DetailLettucy = () => {
  return (
    <section className="py-6 px-8">
      ...
      <div className="py-6 flex items-center justify-center gap-4 lg:gap-8 flex-wrap">
        <Card className="max-w-lg hover:scale-105 transition-all cursor-pointer">
          <CardContent className="flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="lg:leading-7 leading-5 text-xs lg:text-sm [&:not(:first-child)]:mt-2 text-muted-foreground">
